...
- (void)updateTimeLabel
{
    ...
    if ([cmp1 day] == [cmp2 day])
        _lastUpdateTimeLabel.text = [NSString stringWithFormat:/*@"最后更新：%@"*/@"Last Update: Today %@", time];
    else
        _lastUpdateTimeLabel.text = [NSString stringWithFormat:/*@"最后更新：%@"*/@"Last Update: %@", time];
}
